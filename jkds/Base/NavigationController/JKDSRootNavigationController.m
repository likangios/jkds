//
//  JKDSRootNavigationController.m
//  jkds
//
...
@interface JKDSRootNavigationController ()<UINavigationControllerDelegate,UIGestureRecognizerDelegate>
...
@implementation JKDSRootNavigationController
...
//    [navBar setBackgroundImage:[UIImage imageWithColor:CNavBgColor] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
    [navBar setBackgroundImage:[UIImage imageNamed:@"tabBarBj"] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
